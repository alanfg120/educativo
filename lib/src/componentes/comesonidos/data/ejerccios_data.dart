...
Map<String,List<EjercicioComesonidoClass>>  ejerciciosMap = {
 'ejercicio1': [
                EjercicioComesonidoClass(letra: 'M',accept: false),
                EjercicioComesonidoClass(letra: 'E',accept: false),
                EjercicioComesonidoClass(letra: 'S',accept: false),
 ...
 'ejercicio2': [
                ...
                EjercicioComesonidoClass(letra: 'O',accept: false),
               ],
 'ejercicio3': [
                EjercicioComesonidoClass(letra: 'M',accept: false),
                EjercicioComesonidoClass(letra: 'O',accept: false),
                EjercicioComesonidoClass(letra: 'M',accept: false),
                EjercicioComesonidoClass(letra: 'I',accept: false),
                EjercicioComesonidoClass(letra: 'A',accept: false),
               ],
 ...
 'ejercicio5': [
                EjercicioComesonidoClass(letra: 'P',accept: false),
                EjercicioComesonidoClass(letra: 'A',accept: false),
                EjercicioComesonidoClass(letra: 'L',accept: false),
                EjercicioComesonidoClass(letra: 'O',accept: false),
                EjercicioComesonidoClass(letra: 'M',accept: false),
                EjercicioComesonidoClass(letra: 'A',accept: false),
               ],
